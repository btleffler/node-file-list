module.exports = function FileListRoutes (root_directory) {
    var path = require("path"),
        Files = require("../FileCollector.js"),
        config = require("../config");

    // Parse the request path and figure out how to respond
    this.file = function fileRoute (req, res){
        ...
        Files.FileCollector.init(path.normalize(root_directory + req.path))
